...
class TriviaQuiz {
    ...
    //     const category = this.categorySelect.value;
    //     const difficulty = this.difficultySelect.value;
    //     const questionType = document.getElementById("question-type").value; // Get selected question type
    ...
    //     if (questionType) {
    //         url += `&type=${questionType}`; // Modify API call based on user's choice
    //     }
    ...
    async startQuiz() {
        ...
        let url = `https://opentdb.com/api.php?amount=10`; // Base URL
        ...
        if (questionType) {
            url += `&type=${questionType}`; // Modify API call based on user's selection
        }
