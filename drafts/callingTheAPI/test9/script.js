class TriviaQuiz {
    constructor() {
        ...
        this.scoreValueElement = document.getElementById('score-value'); // Added
        this.restartButton = document.getElementById('restart-btn');
        this.themeToggle = document.querySelector('.theme-toggle'); // Added
        ...
        this.themeToggle.addEventListener('click', () => this.toggleTheme()); // Added

        // Initialize
        this.initializeTheme(); // Added
        this.fetchCategories();
    }

    initializeTheme() { // Added
